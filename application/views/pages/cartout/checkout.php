...
.do-company-name { font-size: 20px; font-weight: 700; color: #1565c0; letter-spacing: .5px; }
...
<div class="container-fluid">
    ...
    <div class="no-print mb-3 d-flex justify-content-between align-items-center">
        <a href="<?= base_url('items') ?>" class="btn btn-primary btn-rounded text-white">
            ...
            <div class="do-body">
                ...
                <div class="do-meta-grid">
                    ...
                    <div class="do-shipto">
                        ...
                        <?php else : ?>
                            <div style="color:#999; font-style:italic;">Penerima tidak dipilih</div>
                        <?php endif ?>
                    </div>
                </div>
