                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('item') ?>" method="POST">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label class="col-lg-2">Pajak (PPN 11%)</label>
                                    <div class="col-lg-10">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="custom-control custom-switch mt-1">
                                                    <input type="checkbox" class="custom-control-input" id="kena_pajak" name="kena_pajak" value="1" <?= isset($input->kena_pajak) && $input->kena_pajak ? 'checked' : '' ?>>
                                                    <label class="custom-control-label" for="kena_pajak">
                                                        Barang ini dikenakan PPN 11%
                                                    </label>
                                                </div>
                                                <small class="text-muted">Aktifkan jika barang ini dikenakan Pajak Pertambahan Nilai (PPN) sebesar 11%.</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
